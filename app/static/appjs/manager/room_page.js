...
$(function() {
    ...
    $contributeTable.dataTable({
        ...
        "columns": [
            ...
            { "title": "综合贡献指数", "class": "center" },
            { "title": "客户评价", "class": "center", "orderable": false }
        ],
        "data": [
            ["1" , "金石" , "石家庄", "42.1", "31.3","56.3","92.6", returnStar(5)],
            ["2" , "鹿泉" , "石家庄", "63.4", "75.2","36.1","85.3", returnStar(4)],
            ["3" , "二枢纽" , "石家庄", "36.2", "35.7","1.5","78.5", returnStar(3)],
            ["4" , "A机房", "保定", "26.8", "31.9","32.5","49.6", returnStar(2)],
            ["5" , "B机房", "保定", "33.2", "48.4","3.5","67.3", returnStar(3)],
            ["6" , "C机房", "保定", "34.3", "36.9","31.6","56.7", returnStar(3)],
            ["7" , "A机房", "唐山", "32.1", "31.3","53.3","58.5", returnStar(4)],
            ["8" , "B机房", "唐山", "21.1", "41.3","35.8","64.9", returnStar(5)],
    ...
    var contributeOption = {
        ...
        legend: {
            orient : 'vertical',
            x : 'left',
            data:['增值业务','机柜租用','带宽租用','金石','鹿泉','二枢纽','保定A','保定B','唐山A','唐山B','其他']
        },
        calculable : false,
        series : [
            {
                ...
                data:[
                    {value:125.1, name:'增值业务',selected:true},
                    {value:649.2, name:'机柜租用'},
                    {value:1526.3, name:'带宽租用'}
                ]
            },
            {
                name:'机房收入',
