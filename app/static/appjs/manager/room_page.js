...
$(function() {
    ...
    $contributeTable.dataTable({
        ...
        "columns": [
            ...
            { "title": "总收益占比（%）", "class": "center" },
            { "title": "客户评价", "class": "center", "orderable": false }
        ],
        "data": [
            ["1" , "金石" , "石家庄", "42.1", "31.3","56.3","68.6", returnStar(5)],
            ["2" , "鹿泉" , "石家庄", "63.4", "75.2","36.1","35.3", returnStar(4)],
            ["3" , "二枢纽" , "石家庄", "36.2", "35.7","1.5","28.5", returnStar(3)],
            ...
            ["8" , "B机房", "唐山", "21.1", "41.3","35.8","34.9", returnStar(5)],
