...
function portDetail(port, device) {
    var requestString = "?port=\"" + port + "\"&device=\"" + device + "\"";
...
$(function() {
    ...
    $accountTable.dataTable({
        ...
        "data": [
            ...
            [portDetail("GigabitEthernet9/0/2","ne40e-232"), "1 GB","ne40e-232", "智慧星", "95th", "3.2", "3.1", portStatus(0)],
            [portDetail("GigabitEthernet9/0/3","ne40e-232"), "1 GB","ne40e-232", "无","无", "3.2", "0", portStatus(1)],
            [portDetail("Ethernet2/0/5","s9312-253"), "100 M","s9312-253", "智慧星", "0.6 万/月", "0.6", "0.6", portStatus(0)],
            [portDetail("Ethernet2/0/11","s9312-253"), "100 M","s9312-253", "远中和", "0.4 万/月", "0.4", "0.4", portStatus(0)]
        ]
    });
